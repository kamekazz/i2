...
import { connect } from 'react-redux'
 ...
 class MapContainer extends Component {
    ...
    state = {
      location: 
      [
        {contentString:'winfieldflynn',lat:40.747,lng:-73.977,info:'winfieldflynn'},
        {contentString:'oliver',lat:40.748,lng:-73.980,icon:burro,info:'going to AMY MCDONALD'},
        {contentString:'mohaaben',lat:40.758,lng:-73.980,icon:burro,info:'going to Precious MEYER'},

        {contentString:'Molly MORGAN',lat:40.749618,lng:-73.987605,icon:customer,info:'morgan'},
        {contentString:'Amy MCDONALD',lat:40.745694,lng:-73.972079,icon:customer,info:'mcdonald'},
        {contentString:'Precious MEYER',lat:40.739970,lng:-73.976363,icon:customer,info:'meyer'},
      ]
    }
